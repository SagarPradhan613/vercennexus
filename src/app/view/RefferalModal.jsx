...
const ReferralModal = ({ referrals, _id }) => { 
  ...
  const FullURL =
    window.location.protocol + "//" + window.location.host + "?refId=" + _id;
      ...
      <Box sx={{ backgroundColor: COLORS.blue }} borderRadius={"15px"}>
        <Grid container>
          <Grid item lg={6} sm={6} xs={12}>
            <Box display={"flex"}>
              <img
                src="/Images/modal-main.svg"
                width={isMobile ? "150px" : "90%"}
              />
              <Box display={{ sm: "none", xs: "block" }} mt={"1.5rem"}>
                <Heading size="60px">
                  Refer More <br /> Members
                </Heading>
              </Box>
            </Box>
          </Grid>
          <Grid item lg={6} sm={6} xs={12}>
            ...
            >
              ...
              >
                ...
                {copied ? (
                  <FileDownloadDoneIcon sx={{ color: COLORS.White }} />
                ) : (
                  <CopyAllIcon sx={{ color: COLORS.White }} />
                )}
              </Button>
              <Box
                sx={{
          ...
          >
            <TableHead>
              <TableRow>
                ...
                <TableCell
                  align="right"
                  sx={{ paddingRight: isMobile ? "5rem" : "8rem" }}
                >
                  ID
                </TableCell>
