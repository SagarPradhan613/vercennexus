          ...
          <InviteModal inviteError={inviteError} handleSubmit={handleSubmit} setOtp={setOtp} otp={otp} open={openInvite} login={login} handleClose={handleCloseInvite} />
                ...
                <div className="newgradient-background" style={{ opacity: opac }}>
                    ...
                    <div className="lg:flex w-full  px-4 lg:pt-0 lg:px-0 lg:pb-20 relative" >
                        <div className="lg:w-1/2 text-center lg:text-left res-about-hero-left lg:pl-32  w-full">
                            <p className="grad-text nexus-hero-head text-white text-[50px] leading-[3rem] font-bold lg:text-6xl">
                                An innovative community driven hub
                            </p>
                                ...
                                <div className="flex res-gap gap-10 mt-4 res-powerby-mb">
                                    <div className="flex gap-4 items-center">
                                        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_1330_2935)">
                                                <path d="M18 36C8.05887 36 0 27.9411 0 18C0 8.05887 8.05887 0 18 0C27.9411 0 36 8.05887 36 18C36 27.9411 27.9411 36 18 36Z" fill="#627EEA" />
                                                <path d="M17.4397 4.5V14.4787L9.00557 18.2475L17.4397 4.5Z" fill="white" fill-opacity="0.602" />
                                                <path d="M17.4398 4.5L25.875 18.2475L17.4398 14.4787V4.5Z" fill="white" />
                                                <path d="M17.4397 24.7144V31.4947L8.99995 19.8184L17.4397 24.7144Z" fill="white" fill-opacity="0.602" />
                                                <path d="M17.4398 31.4947V24.7132L25.875 19.8184L17.4398 31.4947Z" fill="white" />
                                                <path d="M17.4397 23.1451L9.00557 18.2479L17.4397 14.4814V23.1451Z" fill="white" fill-opacity="0.2" />
                                                <path d="M25.875 18.2479L17.4398 23.1451V14.4814L25.875 18.2479Z" fill="white" fill-opacity="0.602" />
                                            </g>
                                            <defs>
                                                <clipPath id="clip0_1330_2935">
                                                    <rect width="36" height="36" fill="white" transform="matrix(-1 0 0 1 36 0)" />
                                                </clipPath>
                                            </defs>
                                        </svg>
                                        <p className="font-bold lg:text-3xl text-2xl text-white">Ethereum</p>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-4">
                                            <svg width="32" height="26" viewBox="0 0 32 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M27.0054 20.2996C26.8245 20.9889 25.866 20.9889 25.685 20.2996L23.5769 12.2715C23.5361 12.1163 23.5361 11.9529 23.5769 11.7977L25.445 4.68342C25.6102 4.05449 26.1687 3.61719 26.8068 3.61719H29.5488C30.4758 3.61719 31.1505 4.51439 30.9106 5.42803L27.0054 20.2996ZM8.91829 12.2581C8.95902 12.1029 8.95902 11.9395 8.91829 11.7843L7.05367 4.68342C6.88853 4.05449 6.33 3.61719 5.69194 3.61719H2.94985C2.02289 3.61719 1.34821 4.51439 1.58812 5.42803L5.48972 20.2862C5.67071 20.9755 6.6292 20.9755 6.8102 20.2862L8.91829 12.2581Z" fill="white" />
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M14.8568 21.9167C14.795 22.152 14.9688 22.3831 15.2075 22.3831H17.2987C17.5375 22.3831 17.7113 22.152 17.6495 21.9167L16.6039 17.9348C16.5077 17.5686 15.9985 17.5686 15.9024 17.9348L14.8568 21.9167Z" fill="white" />
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M12.7746 24.4661C12.6145 25.0759 12.0729 25.5 11.4542 25.5H8.62366C7.72479 25.5 7.07057 24.63 7.30318 23.744L13.1099 1.63083C13.2851 0.963816 13.8774 0.5 14.5542 0.5H17.9228C18.5996 0.5 19.1919 0.963816 19.3671 1.63083L25.1738 23.744C25.4064 24.63 24.7522 25.5 23.8533 25.5H21.0228C20.4041 25.5 19.8625 25.0759 19.7024 24.4661L16.8781 13.7108C16.7028 13.0431 15.7742 13.0431 15.5989 13.7108L12.7746 24.4661Z" fill="white" />
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M27.0133 20.2992C26.8324 20.9885 25.8739 20.9885 25.6929 20.2992L23.5848 12.2712C23.544 12.1159 23.544 11.9525 23.5848 11.7973L26.2714 1.56622C26.4365 0.937309 26.995 0.5 27.6331 0.5H30.3752C31.3021 0.5 31.9768 1.39721 31.7369 2.31085L27.0133 20.2992ZM8.92619 12.2578C8.96692 12.1026 8.96692 11.9391 8.92619 11.7839L6.2431 1.56622C6.07796 0.937309 5.51946 0.5 4.88137 0.5H2.1393C1.21234 0.5 0.537658 1.39721 0.777572 2.31085L5.49762 20.2858C5.67861 20.9751 6.6371 20.9751 6.8181 20.2858L8.92619 12.2578Z" fill="white" />
                                            </svg>
                                            <p className="font-bold lg:text-3xl text-2xl text-white">web3auth</p>
                        ...
                        <div className="lg:w-1/2 px-6 lg:px-10 res-about-top-right text-center lg:text-left mt-6 lg:mt-0 w-full ">
                            <p className="font-semibold text-base res-about-hero-para lg:text-2xl text-white opacity-80">Nexus offer opportunities and carve new ways to financial freedom and innovation.</p>
                            ...
                            <div className=" mt-6 justify-center lg:justify-start lg:mt-20 flex gap-4 lg:gap-6">
                                ...
                                <div className="border hover:bg-black hover:border-black transition-all duration-500 relative z-50 ease-in-out  rounded-[36px] px-6 lg:px-10 flex justify-center items-center  border-white">
                                    <p className=" font-semibold text-sm lg:text-base poppins text-white">Open DAPP</p>
                                </div>
                                ...
                                <div className="flex justify-center mt-6 w-full gap-6">
                                    <div>
                                        <div className="flex gap-2 items-center">
                                            ...
                                            <p className="font-bold lg:text-3xl text-base text-white">Ethereum</p>
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <p className="font-bold lg:text-3xl text-base text-white">web3auth</p>
                ...
                <div className="w-full flex lg:flex-row flex-col lg:px-20 lg:py-20  px-10 py-6">
                    <div className="lg:w-[57%] lg:px-10 lg:text-left text-center w-full">
                        ...
                        <p className="font-bold text-sm lg:text-lg text-white opacity-50 mt-6 lg:mt-14 grad-text-gray">Nexus cultivates community support for launches by facilitating engagement. Our tools recognize and reward active contributors, ensuring their support is recognized and valued. Through this collaborative approach we share success together while empowering users to champion projects they believe in.</p>
                        <p className="font-bold text-sm lg:text-lg text-white opacity-50 mt-6 grad-text-gray">Join Nexus in shaping the future of launches, where every supporter plays a vital role in driving meaningful change. As part of our community, your contributions make a difference.</p>
                    </div>
                    ...
                    <div className="flex w-full lg:py-16 py-6 res-better-flex lg:flex-row flex-col lg:gap-8 gap-3">
                        <div className="flex group hover:scale-105 transition-all duration-500 ease-in-out rounded-[20px] lg:rounded-[38px] better-height working-step-box justify-between flex-col lg:px-12 lg:py-10 px-8 py-8">
                            <div className="lg:block hidden">
                                ...
                                {/* <div className="bg-[#0075FF] w-[75px] h-[75px] rounded-[10px] flex justify-center items-center"> */}
                                <svg className=" group-hover:scale-90 transition-all duration-500 ease-in-out" width="75" height="75" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M34.061 2.15654C34.061 0.730912 32.4056 -0.0552523 31.3007 0.845684L25.1136 5.8908C24.7197 6.21202 24.4911 6.69336 24.4911 7.20166V20.0318C24.4911 21.3905 22.9702 22.1946 21.8474 21.4297L15.0023 16.7665C13.8794 16.0016 12.3586 16.8058 12.3586 18.1644V24.145C12.3586 24.6784 12.6102 25.1805 13.0375 25.4998L24.0408 33.723C24.3332 33.9415 24.6883 34.0596 25.0533 34.0596H32.3696C33.3038 34.0596 34.061 33.3023 34.061 32.3682V2.15654Z" fill="#0075FF" />
                                    <path d="M0.584473 32.2399C0.584473 33.6656 2.23994 34.4517 3.3448 33.5508L9.53187 28.5057C9.9258 28.1845 10.1544 27.7031 10.1544 27.1948V14.3646C10.1544 13.006 11.6753 12.2018 12.7981 12.9668L19.6432 17.6299C20.7661 18.3949 22.2869 17.5907 22.2869 16.2321V10.2515C22.2869 9.7181 22.0353 9.21594 21.6081 8.89663L10.6047 0.673443C10.3124 0.454948 9.95716 0.336887 9.59218 0.336887H2.27589C1.34175 0.336887 0.584473 1.09416 0.584473 2.02831V32.2399Z" fill="#0075FF" />
                                </svg>
                        ...
                        <div className="flex group hover:scale-105 transition-all duration-500 ease-in-out rounded-[20px] lg:rounded-[38px] better-height working-step-box justify-between flex-col lg:px-12 lg:py-10 px-8 py-8">
                            <div className="lg:block hidden">
                                ...
                                <svg className="group-hover:scale-90 transition-all duration-500 ease-in-out" width="74" height="75" viewBox="0 0 43 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M13.0423 5.17863C15.3735 5.80636 17.6419 6.9477 20.2014 9.18186C20.6224 9.5486 20.8835 10.0654 20.9288 10.6219C20.9741 11.1785 20.8001 11.7307 20.4439 12.1607L19.2398 13.6159L22.4641 16.0555L24.2331 13.7672C24.4101 13.5378 24.6318 13.3467 24.8847 13.2055C25.1377 13.0644 25.4167 12.976 25.7049 12.9459C25.993 12.9157 26.2842 12.9444 26.561 13.0302C26.8377 13.1159 27.0941 13.257 27.3147 13.4447C29.2493 15.0883 29.8998 16.6776 30.0511 18.1299C30.0825 18.4466 30.0882 18.7291 30.091 18.9374V19.063C30.6731 19.5965 31.2809 20.1158 31.9029 20.638L36.9932 14.6517L34.9617 12.9854L34.6763 13.0367L34.6164 13.0453C34.2443 13.1185 33.8678 13.1672 33.4893 13.1908C33.1127 13.2079 32.1882 13.2165 31.3893 12.5716C30.8276 12.0957 30.4385 11.4478 30.2822 10.7284C30.1709 10.2718 30.1281 9.78677 30.1024 9.48431L30.0967 9.45007C30.0863 9.32824 30.0748 9.2065 30.0625 9.08485C24.8865 5.66369 18.6777 3.76622 13.0423 5.17577V5.17863ZM19.8447 19.4396L16.5063 16.9173L5.17282 30.6247C5.11267 30.6975 5.06757 30.7815 5.04015 30.8719C5.01272 30.9623 5.00352 31.0572 5.01308 31.1512C5.02263 31.2452 5.05076 31.3363 5.09581 31.4193C5.14087 31.5023 5.20196 31.5756 5.27554 31.6348L7.88064 33.7177C7.95452 33.7769 8.03944 33.8208 8.13046 33.8469C8.22148 33.8729 8.31678 33.8806 8.41079 33.8694C8.50481 33.8583 8.59567 33.8285 8.67806 33.7819C8.76046 33.7353 8.83275 33.6727 8.89072 33.5979L19.8447 19.4396ZM15.7501 11.1221C14.5844 10.2878 13.2775 9.67111 11.8924 9.3017C10.5713 8.95074 9.3016 8.82519 7.69803 8.66255C7.05073 8.59831 6.40395 8.52888 5.75776 8.45426C5.33756 8.40494 4.9414 8.23217 4.61935 7.95778C4.29731 7.6834 4.06382 7.31971 3.94839 6.91267C3.83297 6.50563 3.84079 6.07351 3.97086 5.67091C4.10094 5.26832 4.34743 4.91331 4.6792 4.65076C13.8384 -2.59672 25.2461 0.579046 32.9672 5.8834C33.5964 6.36158 34.0305 7.05215 34.1884 7.82652C34.2626 8.1461 34.3025 8.48279 34.3311 8.75386C34.6002 8.71051 34.8718 8.68383 35.1443 8.67397C35.5523 8.66255 36.4568 8.68252 37.2386 9.32167L37.6609 9.66407C38.9449 10.7141 39.8666 11.4702 41.3988 12.7514C41.6158 12.9327 41.7947 13.1552 41.9252 13.4061C42.0557 13.6569 42.1352 13.9312 42.1591 14.213C42.183 14.4947 42.1508 14.7784 42.0644 15.0477C41.9779 15.3169 41.839 15.5664 41.6556 15.7816L33.7889 25.0264C33.4231 25.4559 32.9025 25.7235 32.3403 25.771C31.7782 25.8186 31.22 25.6423 30.7872 25.2804L30.0653 24.6812C28.9455 23.7708 27.855 22.8249 26.7954 21.845C26.1946 21.2589 25.8465 20.4613 25.8253 19.6222C25.8139 19.4339 25.8139 19.2199 25.811 19.0744V18.9888C25.8107 18.9041 25.8088 18.8194 25.8053 18.7348L12.2748 36.2201C11.8694 36.7441 11.3639 37.1821 10.7875 37.5088C10.2112 37.8354 9.57562 38.0442 8.91783 38.1228C8.26004 38.2014 7.59319 38.1483 6.95611 37.9666C6.31904 37.785 5.72447 37.4784 5.20706 37.0647L2.60197 34.9817C2.08458 34.5678 1.65477 34.0549 1.33757 33.4732C1.02037 32.8914 0.822139 32.2523 0.754418 31.5932C0.686698 30.934 0.750846 30.268 0.943124 29.6339C1.1354 28.9998 1.45197 28.4103 1.87437 27.8998L15.7501 11.1221Z" fill="#0075FF" />
                                </svg>
                        ...
                        <div className="flex group hover:scale-105 transition-all duration-500 ease-in-out rounded-[20px] lg:rounded-[38px] better-height working-step-box justify-between flex-col lg:px-12 lg:py-10 px-8 py-8">
                            <div className="lg:block hidden">
                                ...
                                <svg className="group-hover:scale-90 transition-all duration-500 ease-in-out" width="74" height="75" viewBox="0 0 41 43" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="
.2885 35.0149 31.8978 35.4818 31.1165L36.357 29.6522C36.8499 28.8275 37.0964 28.415 37.1389 27.9927C37.1747 27.636 37.1092 27.2765 36.9499 26.9555C36.7613 26.5753 36.3852 26.2762 35.6333 25.678L34.2525 24.5799C33.7726 24.1983 33.5327 24.0076 33.3824 23.803C33.2199 23.582 33.1505 23.4383 33.0785 23.1735C33.012 22.9285 33.012 22.534 33.012 21.7452C33.012 20.9565 33.012 20.5622 33.0785 20.3172C33.1505 20.0524 33.2199 19.9087 33.3824 19.6875C33.5327 19.4831 33.7726 19.2922 34.2523 18.9108L35.6333 17.8125C36.3854 17.2144 36.7615 16.9154 36.9501 16.5351C37.1094 16.214 37.1747 15.8546 37.1389 15.4979C37.0964 15.0756 36.8501 14.6632 36.357 13.8384L35.4818 12.3741C35.0149 11.5928 34.7815 11.2022 34.4485 10.9687C34.1669 10.7714 33.8375 10.6539 33.4946 10.6287C33.089 10.5988 32.6611 10.7537 31.8052 11.0634L29.8743 11.7623C29.3091 11.9668 29.0266 12.0691 28.7743 12.0901C28.5265 12.1107 28.3767 12.0978 28.1361 12.0352C27.8911 11.9714 27.5613 11.783 26.9018 11.4063C26.8513 11.3775 26.8006 11.349 26.75 11.3209C26.0603 10.9397 25.7155 10.749 25.529 10.5654C25.3461 10.3851 25.2558 10.2583 25.1455 10.0263C25.0333 9.79007 24.9801 9.48268 24.8742 8.86794L24.5768 7.14507Z" fill="#0075FF" />
                                </svg>
                ...
                <div className="w-full hideTopAnimationnodelay flex mt-16 flex-col lg:px-20 lg:py-20  px-10 py-6">
                    <div className="flex w-full justify-center items-center">
                        <p className="text-white grad-text-gray font-bold lg:text-6xl text-2xl">Why Choose Nexus?</p>
                    </div>
                    ...
                    <div className="flex w-full lg:px-16 mt-6 lg:mt-24 lg:flex-row flex-col gap-6 lg:gap-10 ">
                        <div className="l2-box hover:scale-105 transition-all duration-500 ease-in-out rounded-[20px] lg:rounded-[36px] text-center lg:px-16 lg:py-16 px-6 py-4  border-[1.5px] border-[#FFFFFF] border-opacity-20">
                            <p className="lg:text-xl text-white opacity-50 lg:opacity-80 font-bold text-sm">Unlike platforms that favor large investors, Nexus ensures equal opportunities for all participants in the ecosystem, where both crypto whales and small fishes alike can thrive.
                            </p>
                        </div>
                ...
                <div className="w-full hideTopAnimationnodelay flex mt-16 flex-col lg:px-20 lg:py-20  px-10 py-6">
                    <div className="flex w-full justify-center items-center">
                        <p className="text-white grad-text-gray font-bold lg:text-6xl text-2xl">Who are we?</p>
                    </div>
                    ...
                    <div className="lg:mt-16 mt-6 w-full lg:px-32 flex flex-col  lg:gap-0 relative">
                        ...
                        <div className="who-we-are-steps hover:scale-1 transition-all duration-500 ease-in-out pb-10  rounded-[20px] lg:rounded-[36px] lg:text-left text-center lg:px-10 lg:pl-24 lg:py-10 px-6 py-4  border-[1.5px] border-[#FFFFFF] border-opacity-20">
                            <p className="lg:text-xl text-white opacity-50 lg:opacity-80 font-bold text-sm">Comprising dynamic individuals with diverse skill sets and backgrounds, each member brings a unique perspective and expertise to the table and we collectively drive the vision of Nexus forward.</p>
                        </div>
                        ...
                        <div className="who-we-are-steps pb-10 lg:-mt-16 rounded-[20px] lg:rounded-[36px] lg:text-left text-center lg:px-10 lg:pl-24 lg:py-10 px-6 py-4  border-[1.5px] border-[#FFFFFF] border-opacity-20">
                            <p className="lg:text-xl text-white opacity-50 lg:opacity-80 font-bold text-sm">We hold ourselves to the highest standards of professionalism, integrity, and dedication. With a relentless focus on delivering exceptional results, we continuously strive to exceed expectations and set new benchmarks for success.</p>
                        </div>
                        ...
                        <div className="who-we-are-steps lg:-mt-16 relative pb-10  rounded-[20px] lg:rounded-[36px] lg:text-left text-center lg:px-10 lg:pl-24 lg:py-10 px-6 py-4  border-[1.5px] border-[#FFFFFF] border-opacity-20">
                            ...
                            <p className="lg:text-xl text-white opacity-50 lg:opacity-80 font-bold text-sm">At the heart of the Nexus team lies a deep-seated commitment to our community. We recognize community is the lifeblood of any platform, and we prioritize building meaningful relationships and connections with our users.</p>
                        </div>
                ...
                <div className="w-full hideTopAnimationnodelay flex mt-16 flex-col lg:px-20 lg:py-20  px-10 py-6">
                    <div className="flex w-full justify-center items-center">
                        <p className="text-white grad-text-gray font-bold lg:text-6xl text-2xl">Nexus Airdrop</p>
                    </div>
                    <div className="w-full text-center justify-center flex">
                        <p className="lg:text-2xl lg:w-[60%] text-sm opacity-70 lg:opacity-70 text-white mt-3 lg:mt-6 ">Become a part of Nexus Airdrop by following simple steps.</p>
                    </div>
                    ...
                    <div className="flex justify-center relaive w-full lg:px-16 mt-6 lg:mt-24 lg:flex-row flex-col gap-10 lg:gap-10 ">
                        <div className="relative timeline-box hover:scale-105 transition-all duration-500 ease-in-out">
                            <div className="l2-box res-airdrop-box rounded-[20px] lg:rounded-[36px] text-center lg:px-20 lg:pb-20 pb-16 lg:pt-10 px-6 py-8  border-[1.5px] border-[#FFFFFF] border-opacity-20">
                                <p className="text-white lg:text-4xl text-3xl grad-text-gray whitespace-nowrap font-bold">Sign Up</p>
                        ...
                        <div className="relative timeline-box hover:scale-105 transition-all duration-500 ease-in-out">
                            <div className="l2-box res-airdrop-box rounded-[20px] lg:rounded-[36px] text-center lg:px-20 lg:pb-20 pb-16 lg:pt-10 px-6 py-8  border-[1.5px] border-[#FFFFFF] border-opacity-20">
                                <p className="text-white lg:text-4xl text-3xl grad-text-gray font-bold">Redeem</p>
                                {/* <p className="lg:text-xl text-base opacity-50 text-white mt-2">Coming Soon</p> */}
                ...
                <div className="w-full">
                    <div className="footergradient-bg pt-8 pb-10 lg:pt-14 lg:pb-8 lg:px-20 flex flex-col">
                        <div className="lg:flex-row lg:justify-between flex-col flex">
                            <div>
                                <p className="font-bold grad-text text-3xl text-center lg:text-left lg:text-5xl">Have an invite?</p>
                            </div>
